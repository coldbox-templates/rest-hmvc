...
This template gives you the base for building RESTFul web services with ColdBox in a modular (HMVC) fashion.  This template will create an `api` module with a `v1` sub-module within it.  It will leverage ColdBox modular inherit entry points to mimic the URL resources to your modular design.
