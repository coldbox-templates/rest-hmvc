		...
		<div class="col-md-12">
			<form name="runnerForm" id="runnerForm">
				...
				<fieldset>
					...
					<cfif url.path neq "/">
						<a href="index.cfm?path=#URLEncodedFormat( backPath )#"><button type="button" class="btn btn-secondary btn-sm my-1">&##xAB; Back</button></a><br><hr>
					</cfif>
					<cfloop query="qResults">
						...
						<cfif qResults.type eq "Dir">
							<a class="btn btn-secondary btn-sm my-1" href="index.cfm?path=#dirPath#">&##x271A; #qResults.name#</a><br/>
